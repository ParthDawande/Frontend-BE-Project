...
//         <p>🌀 <b>Curvy and Complex Letters:</b> The shapes can be tricky to read, especially in handwriting.</p>

//         <p>🤖 <b>That’s Where DevaScan Helps!</b> Our tool uses AI to recognize, correct, and guide your Devanagari writing, making learning super easy and fun!</p>
  ...
  return (
    <>
      ...
      <section className="about-devascan">
        <h2>Revolutionize Your Devanagari Learning with DevaScan</h2>
        <p>
          DevaScan is an AI-powered educational tool designed to help students master the Devanagari script.
          Whether you're checking spellings, recognizing handwritten characters, or identifying inaccuracies,
          DevaScan is your all-in-one solution.
        </p>
      </section>
